...
st.title("Hello Welcome to the class!!!")

st.header("This is a header")
st.subheader("This is a subheader")
st.text("Hello How are you all doing")
...
img = Image.open("Image.jpg") # Open the image file
st.image(img, width=200) # Display the image with a specified width

import streamlit as st

st.image(r"C:\Logo.png", width=200)
